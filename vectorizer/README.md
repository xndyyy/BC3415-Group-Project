...
- **Class: `VectorDB`**
  - **Methods:**
    ...
    - `generate_embedding_async`: Generates embeddings asynchronously.
...
This file is responsible for creating and indexing multiple collections (car rentals, trips, flights, hotels) into Qdrant.
